...
def assembleDataframe(tweets):
    ...
    text_tweets = [[tweet.date, tweet.permalink, tweet.text, tweet.username, tweet.favorites, tweet.retweets, tweet.geo,
                    tweet.hashtags] for tweet in tweets]
    tweets_df = pd.DataFrame(text_tweets,
                             columns=['Datetime', 'Permalink', 'Text', 'Username', 'Favorites', 'Retweets', 'Geo',
                                      'Hashtags'])
